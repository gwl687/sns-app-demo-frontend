import 'package:demo10/pages/social/store/timelineIntered_vm.dart';
    ...
    return Scaffold(
      ...
      body: Consumer<TimelineViewModel>(
        builder: (context, vm, child) {
          ...
          final sortedAvatars = vm.avatars[widget.timelindId]!.entries.toList()
